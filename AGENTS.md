...
- **E2E**(dev 기동 후 · exit 0 정상 · `--self-test`): `e2e_smoke.py`=역할 5종 × 라우트 13개 **65칸**(열려야 48 · 막혀야 17) · `e2e_interact.py`=필터·정렬·팝업을 **눌러서** 16건. 🔴 admin 만으론 「막히는가」를, smoke 만으론 「눌러서 되는가」를 못 잰다 → [`docs/gotchas-playwright-ui.md`](./docs/gotchas-playwright-ui.md).
