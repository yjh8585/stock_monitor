...
VERIFIED_JUMPS: dict[tuple[str, int], str] = {
  ...
  ('에스케이온', 2021): '2021-10-01 SK이노베이션 물적분할로 설립 — FY2021 은 3개월 부분기간(연혁 확인)',
  ...
  ('에스케이온', 2024): (
    '2024-11-01 에스케이트레이딩인터내셔널 흡수합병 — FY2024 는 2개월분만 들어갔고 FY2025 가 온기다'
    '(사업보고서 「사업의 개요」: 석유사업 2025년 매출 49조 131억). 2025-02 엔텀·2025-11 엔무브도 흡수합병'
  ),
