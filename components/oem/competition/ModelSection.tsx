...
function MarketPanel({ market }: { market: CompetitionOutlook['markets'][number] }) {
  ...
  return (
    ...
    >
      ...
      {outlook.markets.length === 0 ? (
        ...
        <MarketPanel market={outlook.markets[0]} />
      ) : (
      ...
      <ModelNarrative outlook={outlook} />
    </section>
  );
}
