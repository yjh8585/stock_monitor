...
import type { FinanceRow, LoanRow } from '@/lib/finance/types';
...
export default function FinanceDashboard({ rows, loanRows }: Props) {
  ...
  return (
    <div className="max-w-[1600px] mx-auto px-6 py-4 space-y-4">
      ...
      {/* 3. 이인텔리전스 대여금 — KPI + 계획 대비 실적 */}
      <LoanKpiCards kpis={loanKpis} />
      <LazyMount className="min-h-[420px] md:min-h-[500px]">
        <ChartSection title="3. 대여금 계획 대비 실적 (이인텔리전스)" unit="억원">
