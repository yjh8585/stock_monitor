...
**규모**: 두 글자 한글 회사명 **39곳이 뉴스 8,621건**을 갖고 있고, 100건을 넘는 13곳이
**8,242건**이다. 전체 뉴스 26,883건의 **31%**다.
⚠️ **전부가 오염은 아니다** — 「기아」(1,454건)는 진짜 회사 기사다. 그래서 이름 길이만으로
일괄 삭제하면 안 되고, **회사당 표본을 열어 보고** 가려야 한다.

**왜 안 잡혔나**: 뉴스는 개수만 늘 뿐 «틀린 값» 이 아니라서 어떤 검사에도 안 걸린다.
화면에서도 그 회사를 눌러야 보인다. 🔴 **검사기가 없는 데이터는 아무도 안 본다.**

**처방 방향**(아직 안 함): 수집 질의에 회사명만 쓰지 말고 **맥락어를 함께** 걸거나
(「<회사명> 매출」·「<회사명> 수주」), 종목코드·영문명을 병용한다. 이미 쌓인 것은
회사별로 표본을 보고 지운다.
