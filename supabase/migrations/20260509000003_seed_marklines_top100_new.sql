...
INSERT INTO companies (ticker, name, name_kr, country, currency, market, data_source, status, company_type) VALUES ('6773.T', 'Pioneer Corporation', '파이오니어', 'JP', 'JPY', 'TSE', 'yfinance', 'active', '반도체') ON CONFLICT (ticker) DO NOTHING;
INSERT INTO companies (ticker, name, name_kr, country, currency, market, data_source, status, company_type) VALUES ('300124.SZ', 'Shenzhen Inovance Technology', '이노뱅스', 'CN', 'CNY', 'SZSE', 'yfinance', 'active', '반도체') ON CONFLICT (ticker) DO NOTHING;
...
INSERT INTO companies (ticker, name, name_kr, country, currency, market, data_source, status, company_type) VALUES ('MBLY', 'Mobileye Vision Technologies', '모빌아이', 'IL', 'USD', 'NASDAQ', 'yfinance', 'active', '반도체') ON CONFLICT (ticker) DO NOTHING;
...
INSERT INTO companies (ticker, name, name_kr, country, currency, market, data_source, status, company_type) VALUES ('NVDA', 'NVIDIA Corporation', '엔비디아', 'US', 'USD', 'NASDAQ', 'yfinance', 'active', '반도체') ON CONFLICT (ticker) DO NOTHING;
...
INSERT INTO company_pages (company_id, page) SELECT id, 'parts-top100' FROM companies WHERE ticker IN ('ZIL.DE','AUM.DE','Kostal','6773.T','300124.SZ','0425.HK','AAV.BK','002179.SZ','HLE.DE','Hoerbiger','MB.VI','1929.T','MINDAIND.NS','7278.T','MBLY','Ficosa','IAC','MaxionWheels','NVDA','GNTX','7280.T','6923.T','7699.T','IntevaProducts','601501.SS','ABCTechnologies','6835.T','5852.T','300850.SZ','001316.SZ','5334.T') ON CONFLICT DO NOTHING;
