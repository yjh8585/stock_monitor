...
// pnl_entries / pnl_cost_structure 는 사외비 — RLS default-deny로 anon 차단(migration 20260523000002).
// confidentialDb wrapper가 자동으로 service_role 클라이언트로 라우팅 + TypeScript로 사외비 명단 강제.
