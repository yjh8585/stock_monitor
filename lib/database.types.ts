...
// 수동 편집 금지 — 단, 파일 끝의 ViewRow / TableRow 헬퍼는 직접 보존.
  ...
  public: {
    Tables: {
      ...
      oem_sales_model_country_month: {
        Row: { country: string; model: string; oem_group: string; sales: number; year_month: number }
        Insert: { country?: string; model?: string; oem_group?: string; sales: number; year_month: number }
        Update: { country?: string; model?: string; oem_group?: string; sales?: number; year_month?: number }
        Relationships: []
      }
...
export type Tables<
  ...
  TableName extends DefaultSchemaTableNameOrOptions extends {
    ...
    ? keyof (DatabaseWithoutInternals[DefaultSchemaTableNameOrOptions["schema"]][
        "Views"] & DatabaseWithoutInternals[DefaultSchemaTableNameOrOptions["schema"]]["Tables"])
    : never = never,
> = DefaultSchemaTableNameOrOptions extends {
  schema: keyof DatabaseWithoutInternals
}
